...
Рсположение: lib.storage-service
...
- **Interactive Dashboard** (`/project-dashboard`) - **✅ НОВИНКА**: веб-интерфейс интегрированный в Next.js
...
4. **Dashboard URL**: **http://localhost:3000/project-dashboard**
