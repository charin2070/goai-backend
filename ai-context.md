...
4. **UI компоненты** - навбар, таблица, карточки с Shadcn UI
...
### 7.1 Исправление подключения к БД (последняя сессия)
...
- **Документировать изменения** - актуализировать ai-context.md
